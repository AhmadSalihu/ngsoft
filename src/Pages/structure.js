...
const Structure = () => {
    ...
    <div className="fl pa3 pa4-ns bg-white black-70 measure-narrow f3 times">
      <header className="bb b--black-70 pv4">
        ...
        <h4 className="f3 fw4 i lh-title mt0">Earlier on in 2016, the group restructured itself into various sector-focused units in order to deliver improved products and services to its customers. The various sectors include:</h4>
      </header>
